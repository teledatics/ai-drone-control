...
def main():
    ...
    roverPatrolPathPlanner.addUndirectedEdge(NODE_10, NODE_2,  math.dist(nodes[NODE_10], nodes[NODE_2]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_10, NODE_4,  math.dist(nodes[NODE_10], nodes[NODE_4]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_10, NODE_7,  math.dist(nodes[NODE_10], nodes[NODE_7]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_10, NODE_12, math.dist(nodes[NODE_10], nodes[NODE_12]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_10, NODE_15, math.dist(nodes[NODE_10], nodes[NODE_15]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_10, NODE_18, math.dist(nodes[NODE_10], nodes[NODE_18]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_11, NODE_1,  math.dist(nodes[NODE_11], nodes[NODE_1]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_11, NODE_4,  math.dist(nodes[NODE_11], nodes[NODE_4]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_11, NODE_15, math.dist(nodes[NODE_11], nodes[NODE_15]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_11, NODE_16, math.dist(nodes[NODE_11], nodes[NODE_16]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_12, NODE_2,  math.dist(nodes[NODE_12], nodes[NODE_2]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_12, NODE_10, math.dist(nodes[NODE_12], nodes[NODE_10]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_12, NODE_13, math.dist(nodes[NODE_12], nodes[NODE_13]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_12, NODE_18, math.dist(nodes[NODE_12], nodes[NODE_18]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_12, NODE_19, math.dist(nodes[NODE_12], nodes[NODE_19]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_12, NODE_20, math.dist(nodes[NODE_12], nodes[NODE_20]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_13, NODE_2,  math.dist(nodes[NODE_13], nodes[NODE_2]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_13, NODE_3,  math.dist(nodes[NODE_13], nodes[NODE_3]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_13, NODE_12, math.dist(nodes[NODE_13], nodes[NODE_12]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_13, NODE_19, math.dist(nodes[NODE_13], nodes[NODE_19]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_13, NODE_20, math.dist(nodes[NODE_13], nodes[NODE_20]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_14, NODE_1,  math.dist(nodes[NODE_14], nodes[NODE_1]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_14, NODE_5,  math.dist(nodes[NODE_14], nodes[NODE_5]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_14, NODE_8,  math.dist(nodes[NODE_14], nodes[NODE_8]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_15, NODE_4,  math.dist(nodes[NODE_15], nodes[NODE_4]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_15, NODE_10, math.dist(nodes[NODE_15], nodes[NODE_10]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_15, NODE_11, math.dist(nodes[NODE_15], nodes[NODE_11]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_15, NODE_16, math.dist(nodes[NODE_15], nodes[NODE_16]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_15, NODE_18, math.dist(nodes[NODE_15], nodes[NODE_18]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_16, NODE_11, math.dist(nodes[NODE_16], nodes[NODE_11]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_16, NODE_15, math.dist(nodes[NODE_16], nodes[NODE_15]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_16, NODE_18, math.dist(nodes[NODE_16], nodes[NODE_18]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_17, NODE_3,  math.dist(nodes[NODE_17], nodes[NODE_3]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_17, NODE_5,  math.dist(nodes[NODE_17], nodes[NODE_5]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_17, NODE_8,  math.dist(nodes[NODE_17], nodes[NODE_8]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_18, NODE_10, math.dist(nodes[NODE_18], nodes[NODE_10]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_18, NODE_12, math.dist(nodes[NODE_18], nodes[NODE_12]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_18, NODE_15, math.dist(nodes[NODE_18], nodes[NODE_15]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_18, NODE_16, math.dist(nodes[NODE_18], nodes[NODE_16]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_18, NODE_19, math.dist(nodes[NODE_18], nodes[NODE_19]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_19, NODE_3,  math.dist(nodes[NODE_19], nodes[NODE_3]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_19, NODE_12, math.dist(nodes[NODE_19], nodes[NODE_12]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_19, NODE_13, math.dist(nodes[NODE_19], nodes[NODE_13]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_19, NODE_18, math.dist(nodes[NODE_19], nodes[NODE_18]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_19, NODE_20, math.dist(nodes[NODE_19], nodes[NODE_20]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_20, NODE_12, math.dist(nodes[NODE_20], nodes[NODE_12]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_20, NODE_13, math.dist(nodes[NODE_20], nodes[NODE_13]))
    roverPatrolPathPlanner.addUndirectedEdge(NODE_20, NODE_19, math.dist(nodes[NODE_20], nodes[NODE_19]))
