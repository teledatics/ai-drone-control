#!/usr/bin/python3
"""@brief Defines Mosse object tracking filter"""
...
# @brief Defines Mosse object tracking filter
#
# @section description_mosse Description
# Defines classes which encapsulate Mosse object tracking filter algorithm.
# - mosse
#
# @section libraries_mosse Libraries/Modules
...
class mosse:
    def __init__(self, lr=0.125, sigma=100.0, num_pretrain=128, rotate=True):
        self.lr = lr # learning rate
        self.sigma = sigma # the sigma
        self.num_pretrain = num_pretrain # number of pretraining cycles
        self.rotate = rotate # rotate image during pretraining
